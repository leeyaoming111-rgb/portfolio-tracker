...
def _import_realized_records(db, trade_list):
    ...
    Each item: {symbol, currency, realized, cost, shares, company} or
               {ticker, stock_name, currency, total_realized, cost_basis, shares_sold}
    """
    prefix_map = {"NZD": "NZ", "USD": "US", "MYR": "MY", "JPY": "JP",
                  "AUD": "AU", "GBP": "UK", "EUR": "EU"}
    count = 0
...
async def import_realized_pnl(request):
